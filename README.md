...
1. Summarize warnings + make more digestable for average viewer
2. Expand to include food interactions/food advice (ex. avoid grapefruit if taking ssris)
3. Make publically avaliable
